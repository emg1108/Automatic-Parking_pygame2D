...
MAX_ACCELARATION = 1 ## 10->osy
MAX_VELOCITY = 2 ## 60->osy
DEACCELERATION = 2
...
## LEVEL 1
# LVL1_LAYOUT = os.path.join(os.path.dirname( __file__ ),"..", "images\maps\LevelOne", "LVL1.csv") ## osy
LVL1_LAYOUT = os.path.join(os.path.dirname( __file__ ),"..", "images\maps\LevelOne", "LVL1_osy.csv")
